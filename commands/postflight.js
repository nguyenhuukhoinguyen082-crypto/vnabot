...
const AIRLINE_TAIL_EMOJI = {
  VN: '<:hvntail:1514151733901787197>',
...
module.exports = {
  ...
  async execute(interaction) {
    ...
    const postContent = [
      ...
      `> Xin Chào! A new flight has been scheduled from ${flight.origin} to ${flight.destination}, flying onboard our ${flight.aircraft || 'aircraft'}.`,
      ``,
      `> Host: ${host}`,
